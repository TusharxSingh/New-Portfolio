...
interface MenuItemComponentProps extends FlowingMenuItem {
  speed: number;
  textColor: string;
  marqueeBgColor: string;
  marqueeTextColor: string;
  ...
  useEffect(() => {
    const calculateRepetitions = () => {
      ...
      const marqueeContent =
        marqueeInnerRef.current.querySelector(".fm-marquee__part");
    ...
    >
      ...
      >
        <div className="fm-marquee__inner-wrap">
          <div
            className="fm-marquee__inner"
            ref={marqueeInnerRef}
            aria-hidden="true"
          >
            {[...Array(repetitions)].map((_, idx) => (
              <div
                className="fm-marquee__part"
                key={idx}
